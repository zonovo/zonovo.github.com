...
var Galleria = function() {
    ...
    var fullscreen = this._fullscreen = {
        ...
        enter: function(callback) {
            ...
            // swap to big image if it is different from the display image
        ...
        init : function() {
            ...
            var elems = 'overlay box content shadow title info close prevholder prev nextholder next counter image',
                ...
                cssMap = {
                    ...
                    shadow:     abs+'background:#000;width:100%;height:100%;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;',
                    content:    abs+'background-color:#000;top:0px;left:0px;right:0px;bottom:0px;overflow:hidden;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;',
                    info:       abs+'bottom:10px;left:10px;right:10px;color:#555;font:11px/13px arial,sans-serif;height:13px',
                    close:      abs+'top:0px;right:-20px;height:20px;width:20px;background:#1a1a1a;text-align:center;cursor:pointer;color:#101010;font:18px/1em arial,sans-serif;z-index:99999;',
                    image:      abs+'top:10px;left:10px;right:10px;bottom:30px;overflow:hidden;display:block;background: url(data:image/gif;base64,) no-repeat 98% 2%;',
                    prevholder: abs+'width:33%;top:10px;bottom:40px;cursor:pointer;',
                    nextholder: abs+'width:33%;top:10px;bottom:40px;right:-1px;cursor:pointer;',
                    prev:       abs+'top:50%;margin-top:-40px;height:80px;width:30px;background:rgba(0,0,0,0.3);left:20px;display:none;text-align:center;color:#fff;font:bold 40px/1em arial,sans-serif;text-shadow:0 -1px 1px rgba(0,0,0,.5);border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;padding:30px 0 0 10px;',
                    next:       abs+'top:50%;margin-top:-40px;height:80px;width:30px;background:rgba(0,0,0,0.3);right:20px;display:none;text-align:center;color:#fff;font:bold 40px/1em arial,sans-serif;text-shadow:0 -1px 1px rgba(0,0,0,.5);border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;padding:30px 10px 0 0;',
                    title:      'float:left;font: 12px/1em Arial, Sans-Serif;color:#333',
                    counter:    'float:right;margin-left:8px;color:#1a1a1a'
                },
                hover = function(elem) {
                    return elem.hover(
                        function() { $(this).css( 'color', '#555' ); },
                        function() { $(this).css( 'color', '#101010' ); }
                    );
                },
                appends = {};
        ...
        show: function(index) {
            ...
            if ( !lightbox.keymap ) {
                ...
                self.attachKeyboard({
                    ...
                    78: lightbox.showNext, //ASCII Dec keycode for "N"
					74: lightbox.showNext, //ASCII Dec keycode for "J"
					68: lightbox.showNext, //ASCII Dec keycode for "D"
					space: lightbox.showNext,
		
                    left: lightbox.showPrev,
                    80: lightbox.showPrev, //ASCII Dec keycode for "P"
					75: lightbox.showPrev, //ASCII Dec keycode for "K"
					65: lightbox.showPrev //ASCII Dec keycode for "A"
                });
            }
